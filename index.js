// heartlink v0.17.2 — SillyTavern 扩展：心率注入 + 触觉输出（Tavern Bio-Context 参考实现）。构建产物。
...
<div class="pill" part="pill" title="heartlink">
  ...
  }
  {
    ...
    const g = host.setInterval(refreshGuideActive, every);
